...
function updateCarousel() {
    ...
    fetch(url, options) //returns a promise immediatley
        .then((response) => {
            console.log(`Fetch resolved (line 12) at ${new Date().toISOString()}.`);
            return response;
            ...
            for(const file of files){
                ...
                const indicators = document.getElementById('image_coursel_indicators');
